...
export default function Home() {
  return (
    <main className="min-h-screen p-4 md:p-8">
      ...
      <div className="block lg:hidden flex flex-col items-center space-y-6">
      <WidgetProfile
      ...
      {/* Medium Desktop Layout - Single Column (Centered) when columns would overlap */}
      <div className="hidden md:block lg:hidden flex flex-col items-center space-y-6">
      <WidgetProfile
        doctorName="Dr. Sarah Smith"
        specialty="Family Medicine"
        patients="2,500+"
